...
class cobros(OC.Ventana):
    ...
    def __init__(self,padre=None):
        ...
        eng[-1].append(['CB_DENO','Descripci�n','-1','','50','l','100','','','','','','','',''])
        eng[-1].append(['CB_FEC','Fecha','-1','','10','d','10','','','','','','','',''])
        eng[-1].append(['CB_IMPO','Importe','-1','','10','2','10','','','','','','','',''])
        eng[-1].append(['CB_CDAV','N� Venta','-1','','10','%','6','','','','','','','',''])
        pn1[-1].append(eng)
        ...
        btn=[]
        btn.append(['B1',5,10,95,'left.png','','a_PREV','Registro Anterior',''])
        btn.append(['B2',105,10,95,'right.png','','a_NEXT','Registro Posterior',''])
        ...
        btn.append(['B6',105,140,95,'report.png','','a_INFO','Listados',''])
        btn.append(['B7',5,210,95,'select.png','','a_INFO:cobros,cb_ls,LS','',''])
        btn.append(['B8',105,210,95,'exit.png','','a_SALIR','',''])
